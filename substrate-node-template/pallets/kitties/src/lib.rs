...
pub mod pallet {
	...
	#[pallet::getter(fn owner_id)]
	// Learn more about declaring storage items:
	// https://docs.substrate.io/v3/runtime/storage#declaring-storage-items
	pub type OwnerId<T> = StorageValue<_, Id,ValueQuery>;
	...
	pub(super) type Owner<T: Config> = StorageMap<_, Blake2_128Concat, Vec<u8>, Owners<T>, OptionQuery>;
